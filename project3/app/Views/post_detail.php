...
<div class="hero-section text-center">
    <div class="container">
        <h1 class="display-3 fw-bold"><?= esc($post['title']) ?></h1>
        <div class="mt-4">
            <span class="badge bg-light text-dark px-3 py-2 rounded-pill me-2">By <?= esc($post['author']) ?></span>
        ...
        <div class="col-lg-8">
            ...
            <div class="bg-white p-5 rounded shadow-sm">
                ...
                <div class="mt-4">
                    ...
                    <?php if (logged_in()) : ?>
                        <a href="<?= base_url('admin/post/' . $post['id'] . '/edit') ?>" class="btn btn-warning rounded-pill px-4 ms-2">Edit Post</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
